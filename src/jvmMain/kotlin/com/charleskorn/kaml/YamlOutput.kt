...
internal class YamlOutput(
    ...
    override fun encodeEnum(enumDescriptor: SerialDescriptor, index: Int) = emitQuotedScalar(enumDescriptor.getElementName(index), configuration.enumQuoteStyle.scalarStyle)
